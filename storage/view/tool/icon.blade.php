...
<head>
    <meta charset="utf-8">
    <title>@if( !empty($title) ){{$title}}.@endif{{ $app_name }}</title>
    ...
    <link href="/static/plugs/awesome/fonts.css?at={{ $v??date("md") }}" rel="stylesheet">
    <link href="/static/plugs/layui/css/layui.css?at={{ $v??date("md") }}" rel="stylesheet">
...
<ul class="bs-glyphicons-list">
        <li><i class="iconfont icon-cart fa" ></i><div class="icon-title">iconfont icon-cart</div></li>
        <li><i class="iconfont icon-category fa" ></i><div class="icon-title">iconfont icon-category</div></li>
        <li><i class="iconfont icon-close fa" ></i><div class="icon-title">iconfont icon-close</div></li>
        <li><i class="iconfont icon-comments fa" ></i><div class="icon-title">iconfont icon-comments</div></li>
        <li><i class="iconfont icon-cry fa" ></i><div class="icon-title">iconfont icon-cry</div></li>
        <li><i class="iconfont icon-delete fa" ></i><div class="icon-title">iconfont icon-delete</div></li>
        <li><i class="iconfont icon-edit fa" ></i><div class="icon-title">iconfont icon-edit</div></li>
        <li><i class="iconfont icon-email fa" ></i><div class="icon-title">iconfont icon-email</div></li>
        <li><i class="iconfont icon-favorite fa" ></i><div class="icon-title">iconfont icon-favorite</div></li>
        <li><i class="iconfont icon-form fa" ></i><div class="icon-title">iconfont icon-form</div></li>
        <li><i class="iconfont icon-help fa" ></i><div class="icon-title">iconfont icon-help</div></li>
        <li><i class="iconfont icon-information fa" ></i><div class="icon-title">iconfont icon-information</div></li>
        <li><i class="iconfont icon-less fa" ></i><div class="icon-title">iconfont icon-less</div></li>
        <li><i class="iconfont icon-moreunfold fa" ></i><div class="icon-title">iconfont icon-moreunfold</div></li>
        <li><i class="iconfont icon-more fa" ></i><div class="icon-title">iconfont icon-more</div></li>
        <li><i class="iconfont icon-pic fa" ></i><div class="icon-title">iconfont icon-pic</div></li>
        <li><i class="iconfont icon-qrcode fa" ></i><div class="icon-title">iconfont icon-qrcode</div></li>
        <li><i class="iconfont icon-refresh fa" ></i><div class="icon-title">iconfont icon-refresh</div></li>
        <li><i class="iconfont icon-rfq fa" ></i><div class="icon-title">iconfont icon-rfq</div></li>
        <li><i class="iconfont icon-search fa" ></i><div class="icon-title">iconfont icon-search</div></li>
        <li><i class="iconfont icon-selected fa" ></i><div class="icon-title">iconfont icon-selected</div></li>
        <li><i class="iconfont icon-set fa" ></i><div class="icon-title">iconfont icon-set</div></li>
        <li><i class="iconfont icon-smile fa" ></i><div class="icon-title">iconfont icon-smile</div></li>
        <li><i class="iconfont icon-success fa" ></i><div class="icon-title">iconfont icon-success</div></li>
        <li><i class="iconfont icon-survey fa" ></i><div class="icon-title">iconfont icon-survey</div></li>
        <li><i class="iconfont icon-training fa" ></i><div class="icon-title">iconfont icon-training</div></li>
        <li><i class="iconfont icon-viewgallery fa" ></i><div class="icon-title">iconfont icon-viewgallery</div></li>
        <li><i class="iconfont icon-viewlist fa" ></i><div class="icon-title">iconfont icon-viewlist</div></li>
        <li><i class="iconfont icon-warning fa" ></i><div class="icon-title">iconfont icon-warning</div></li>
        <li><i class="iconfont icon-wrong fa" ></i><div class="icon-title">iconfont icon-wrong</div></li>
        <li><i class="iconfont icon-account fa" ></i><div class="icon-title">iconfont icon-account</div></li>
        <li><i class="iconfont icon-add fa" ></i><div class="icon-title">iconfont icon-add</div></li>
        <li><i class="iconfont icon-clock fa" ></i><div class="icon-title">iconfont icon-clock</div></li>
        <li><i class="iconfont icon-remind fa" ></i><div class="icon-title">iconfont icon-remind</div></li>
        <li><i class="iconfont icon-calendar fa" ></i><div class="icon-title">iconfont icon-calendar</div></li>
        <li><i class="iconfont icon-attachment fa" ></i><div class="icon-title">iconfont icon-attachment</div></li>
        <li><i class="iconfont icon-discount fa" ></i><div class="icon-title">iconfont icon-discount</div></li>
        <li><i class="iconfont icon-service fa" ></i><div class="icon-title">iconfont icon-service</div></li>
        <li><i class="iconfont icon-print fa" ></i><div class="icon-title">iconfont icon-print</div></li>
        <li><i class="iconfont icon-box fa" ></i><div class="icon-title">iconfont icon-box</div></li>
        <li><i class="iconfont icon-process fa" ></i><div class="icon-title">iconfont icon-process</div></li>
        <li><i class="iconfont icon-electronics fa" ></i><div class="icon-title">iconfont icon-electronics</div></li>
        <li><i class="iconfont icon-lights fa" ></i><div class="icon-title">iconfont icon-lights</div></li>
        <li><i class="iconfont icon-auto fa" ></i><div class="icon-title">iconfont icon-auto</div></li>
        <li><i class="iconfont icon-filter fa" ></i><div class="icon-title">iconfont icon-filter</div></li>
        <li><i class="iconfont icon-pin fa" ></i><div class="icon-title">iconfont icon-pin</div></li>
        <li><i class="iconfont icon-history fa" ></i><div class="icon-title">iconfont icon-history</div></li>
        <li><i class="iconfont icon-productfeatures fa" ></i><div class="icon-title">iconfont icon-productfeatures</div></li>
        <li><i class="iconfont icon-supplierfeatures fa" ></i><div class="icon-title">iconfont icon-supplierfeatures</div></li>
        <li><i class="iconfont icon-similarproduct fa" ></i><div class="icon-title">iconfont icon-similarproduct</div></li>
        <li><i class="iconfont icon-link fa" ></i><div class="icon-title">iconfont icon-link</div></li>
        <li><i class="iconfont icon-navlist fa" ></i><div class="icon-title">iconfont icon-navlist</div></li>
        <li><i class="iconfont icon-imagetext fa" ></i><div class="icon-title">iconfont icon-imagetext</div></li>
        <li><i class="iconfont icon-text fa" ></i><div class="icon-title">iconfont icon-text</div></li>
        <li><i class="iconfont icon-jifen fa" ></i><div class="icon-title">iconfont icon-jifen</div></li>
        <li><i class="iconfont icon-remind1 fa" ></i><div class="icon-title">iconfont icon-remind1</div></li>
        <li><i class="iconfont icon-map fa" ></i><div class="icon-title">iconfont icon-map</div></li>
        <li><i class="iconfont icon-good fa" ></i><div class="icon-title">iconfont icon-good</div></li>
        <li><i class="iconfont icon-skip fa" ></i><div class="icon-title">iconfont icon-skip</div></li>
        <li><i class="iconfont icon-iconfontplay2 fa" ></i><div class="icon-title">iconfont icon-iconfontplay2</div></li>
        <li><i class="iconfont icon-compass fa" ></i><div class="icon-title">iconfont icon-compass</div></li>
        <li><i class="iconfont icon-share fa" ></i><div class="icon-title">iconfont icon-share</div></li>
        <li><i class="iconfont icon-rejectedorder fa" ></i><div class="icon-title">iconfont icon-rejectedorder</div></li>
        <li><i class="iconfont icon-phone fa" ></i><div class="icon-title">iconfont icon-phone</div></li>
        <li><i class="iconfont icon-exl fa" ></i><div class="icon-title">iconfont icon-exl</div></li>
        <li><i class="iconfont icon-pdf fa" ></i><div class="icon-title">iconfont icon-pdf</div></li>
        <li><i class="iconfont icon-zip fa" ></i><div class="icon-title">iconfont icon-zip</div></li>
        <li><i class="iconfont icon-copy fa" ></i><div class="icon-title">iconfont icon-copy</div></li>
        <li><i class="iconfont icon-save fa" ></i><div class="icon-title">iconfont icon-save</div></li>
        <li><i class="iconfont icon-inquirytemplate fa" ></i><div class="icon-title">iconfont icon-inquirytemplate</div></li>
        <li><i class="iconfont icon-templatedefault fa" ></i><div class="icon-title">iconfont icon-templatedefault</div></li>
        <li><i class="iconfont icon-survey1 fa" ></i><div class="icon-title">iconfont icon-survey1</div></li>
        <li><i class="iconfont icon-data fa" ></i><div class="icon-title">iconfont icon-data</div></li>
        <li><i class="iconfont icon-color fa" ></i><div class="icon-title">iconfont icon-color</div></li>
        <li><i class="iconfont icon-color-filling fa" ></i><div class="icon-title">iconfont icon-color-filling</div></li>
        <li><i class="iconfont icon-video fa" ></i><div class="icon-title">iconfont icon-video</div></li>
        <li><i class="iconfont icon-folder fa" ></i><div class="icon-title">iconfont icon-folder</div></li>
        <li><i class="iconfont icon-packing-labeling fa" ></i><div class="icon-title">iconfont icon-packing-labeling</div></li>
        <li><i class="iconfont icon-online-tracking fa" ></i><div class="icon-title">iconfont icon-online-tracking</div></li>
        <li><i class="iconfont icon-electrical-equipment fa" ></i><div class="icon-title">iconfont icon-electrical-equipment</div></li>
    </ul>
<ul class="site-doc-icon">
    <li>
        <i class="layui-icon layui-icon-heart-fill"></i>
        <div class="icon-title">layui-icon-heart-fill</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-heart"></i>
        <div class="icon-title">layui-icon-heart</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-light"></i>
        <div class="icon-title">layui-icon-light</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-time"></i>
        <div class="icon-title">layui-icon-time</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-bluetooth"></i>
        <div class="icon-title">layui-icon-bluetooth</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-at"></i>
        <div class="icon-title">layui-icon-at</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-mute"></i>
        <div class="icon-title">layui-icon-mute</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-mike"></i>
        <div class="icon-title">layui-icon-mike</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-key"></i>
        <div class="icon-title">layui-icon-key</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-gift"></i>
        <div class="icon-title">layui-icon-gift</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-email"></i>
        <div class="icon-title">layui-icon-email</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-rss"></i>
        <div class="icon-title">layui-icon-rss</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-wifi"></i>
        <div class="icon-title">layui-icon-wifi</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-logout"></i>
        <div class="icon-title">layui-icon-logout</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-android"></i>
        <div class="icon-title">layui-icon-android</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-ios"></i>
        <div class="icon-title">layui-icon-ios</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-windows"></i>
        <div class="icon-title">layui-icon-windows</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-transfer"></i>
        <div class="icon-title">layui-icon-transfer</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-service"></i>
        <div class="icon-title">layui-icon-service</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-subtraction"></i>
        <div class="icon-title">layui-icon-subtraction</div>
    </li>
    <li>
        <i class="layui-icon layui-icon-addition"></i>
        <div class="icon-title">layui-icon-addition</div>
    </li>
    <li>
